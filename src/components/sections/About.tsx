      ...
      <FadeContent blur={true} duration={1000} threshold={0.1}>
        <div>
          <p className="text-2xl font-semibold text-slate-100 leading-snug mb-6">
            Multicultural first-year engineering student in a dual-degree program at CentraleSupélec and McGill
            University, focused on software engineering, machine learning, and NLP.
          </p>
          <div className="space-y-4 text-base text-slate-400 leading-relaxed">
            <p>
              ...
              chatbot serving 2000+ users at ViaRezo and NLP-driven tools for language learning, and 
              building a location-based mobile marketplace for a niche community. My
              technical work spans Python, Java, web frameworks, and machine learning systems.
            </p>
            <p>
              Interested in AI products that improve communication and accessibility across languages.
              Open to connecting about NLP, developer tools, or scalable systems with real-world impact.
            </p>
            <p>
              My previous work includes building a community web forum with Jakarta Servlets, and designing 
              end-to-end model pipelines for MNIST classification and another for transformer translation.
            </p>
            <p>
